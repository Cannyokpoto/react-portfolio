        ...
        <div>
            <main className="main-container">
                ...
                <section className="main-wrapper">
                    <div className="what-we-offer reveal" data-aos="fade-up">
                    ...
                    <div className="core-services">
                        <div className="service from-left" data-aos="fade-right">
                            ...
                            <a href="">Read more  <span>{greater}</span></a>
                        </div>
            
                        <div className="service reveal" data-aos="fade-up">
                        ...
                        <div className="service from-right" data-aos="fade-left">
                ...
                <section className="previous">
                    <div className="previous-contents reveal" data-aos="fade-up">
                        ...
                        <hr/>
                        <a href="">Learn more  <span>{greater}</span></a>
                    </div>
                </section>
            
                <div className="previous-image from-right" data-aos="fade-left">
                    <img src={PHOTOS.PHOTO18} alt=""/>
                </div>
            
                <section className="our-blog">
                    <h2>Our Blog</h2>
                    <span className="user-blog reveal" data-aos="fade-up">
                        <p>Get up to date news on the latest Engineering and B2B trends in the Solar Energy sector</p>
                        <a href="">Unser Blog  <span>{greater}</span></a>
                    </span>
                    ...
                    <section className="latest-blog-posts">
                        ...
                        <div className="blog-posts">
                            <div className="post from-left" data-aos="fade-right">
                            ...
                            <div className="post reveal" data-aos="fade-up">
                                <h3>Monetization opportunities in the Solar Energy industry and how to expand.</h3>
                                <p>Our Mission is to solve Africa’s energy problems, faster; via a two-pronged 
                                    approach to better energy in Africa- clean, renewable energy and energy efficiency.
                                </p>
                            ...
                            <div className="post from-right" data-aos="fade-left">
                                <h3>Monetization opportunities in the Solar Energy industry and how to expand.</h3>
                                <p>Our Mission is to solve Africa’s energy problems, faster; via a two-pronged 
                                    approach to better energy in Africa- clean, renewable energy and energy efficiency.
                                </p>
                ...
                <section className="our-strength">
                    <div className="strength from-left" data-aos="fade-right">
                        <h5>get to know ABOUT</h5>
                        <h3>Our Strength</h3>
                        <p>Energymall is Nigeria’s online and offline retailer of energy and building efficiency products,
                        </p>
                        <a href="">Take a tour  <span>{greater}</span></a>
                    </div>
            
                    <img src={PHOTOS.PHOTO16} alt="" className="from-right" data-aos="fade-left" />
                </section>
            </main>
        </div>
    )
